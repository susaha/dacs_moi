...
class SynthiaDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        label = Image.open(osp.join(self.root, "synthia_mapped_to_cityscapes/%s" % name)) # original code
        # label = Image.open(osp.join(self.root, "parsed_LABELS/%s" % name)) # added by Suman
