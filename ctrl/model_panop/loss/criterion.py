...
class RegularCE(nn.Module):
    ...
    """
    def __init__(self, logger, ignore_label=-1, weight=None):
        super(RegularCE, self).__init__()

        logger.info('ctrl/model_panop/loss/criterion.py --> class RegularCE() : def __init__()')
...
class OhemCE(nn.Module):
    ...
    Arguments:
        ...
        weight: Tensor, a manual rescaling weight given to each class.
    """
    def __init__(self, logger, ignore_label=-1, threshold=0.7,
                 min_kept=100000, weight=None):
        super(OhemCE, self).__init__()

        logger.info('ctrl/model_panop/loss/criterion.py --> class OhemCE() : def __init__()')
...
class DeepLabCE(nn.Module):
    ...
    Arguments:
        ...
        weight: Tensor, a manual rescaling weight given to each class.
    """
    def __init__(self, logger, ignore_label=-1, top_k_percent_pixels=1.0, weight=None):

        logger.info('ctrl/model_panop/loss/criterion.py --> class DeepLabCE() : def __init__() ')
