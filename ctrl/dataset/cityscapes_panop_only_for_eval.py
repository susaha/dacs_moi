...
class CityscapesDataSet(data.Dataset):
    def __init__(self, root, list_path, set='val', max_iters=None, crop_size=(512, 1024),
        ...
        self.logger.info('ctrl/dataset/cityscapes_panop_only_for_eval.py --> class CityscapesDataSet --> __init__() +++')
        ...
        # json_filename = os.path.join(self.root, 'gtFine', 'cityscapes_panoptic_synthia_to_cityscapes_16cls_{}.json'.format('val'))
        ...
        for ann in dataset['annotations']:
            ...
            # panop_label_file = os.path.join(self.root, 'gtFine', 'cityscapes_panoptic_synthia_to_cityscapes_16cls_{}'.format('val'), name)
