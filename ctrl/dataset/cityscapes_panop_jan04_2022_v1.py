...
class CityscapesDataSet(data.Dataset):
    ...
    def visualize(self, name, image, semantic, center, center_w, offset, offset_w, visdepth=False, depth=None, mode=None, train_mode=None,  foreground=None, semantic_weights=None):
        save_dir = '/media/suman/DATADISK2/apps/experiments/CVPR2022/cityscapes_panoptic_gt_label_visualization_Jan_05/cityscapes_panop_jan04_2022_v1/{}'.format(train_mode)
    ...
    def __getitem__(self, index):
        ...
        if self.set == 'train':
            ...
            if self.gen_panop_labels:  # this is reruired for Oracle training
                ...
                # # visual
                # if self.cfg.DEBUG:
                #     self.visualize(name, image, semantic, center, center_w, offset, offset_w, mode='before_crop', train_mode='train_oracle')
