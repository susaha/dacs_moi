...
class SYNTHIADataSetDepth(data.Dataset):
    def __init__(
        ...
        self.logger.info('ctrl/dataset/synthia_panop_jan04_2022_v1.py -->  class SYNTHIADataSetDepth() : __init__()')
    ...
    def visualize(self, name, image, semantic, center, center_w, offset, offset_w, mode=None):
        save_dir = '/media/suman/DATADISK2/apps/experiments/CVPR2022/synthia_panoptic_gt_label_visualization_Jan_05/synthia_panop_jan04_2022_v1/crowd-th-{}'.format(self.crowd_th)
    ...
    def __getitem__(self, index):
        ...
        if self.cfg.DACS_RANDOM_CROP:
            ...
            image, semantic, center, center_w, offset, offset_w, depth = \
                self.dacs_random_crop(image, semantic, center, center_w, offset, offset_w, depth=depth, use_depth=self.use_depth, train_mode=True)
        ...
        # visual
        if self.cfg.DEBUG:
            self.visualize(name, image, semantic, center, center_w, offset, offset_w, mode='after_crop')
