...
class MapillaryDataSet(data.Dataset):
    ...
    def __init__(self, root, list_path, set='val', max_iters=None, crop_size=(512, 1024),
                 ...
                 transform=None, joint_transform=None, cfg=None, gen_panop_labels=False, scale_label=True, viz_outpath=None,  cid=None):
        ...
        self.cid = cid
        self.text_file = open('/home/suman/apps/code/CVPR2022/cvpr2022/class_wise_img_list/mapillary/val/cityscapes_valset_class_wise_img_list_cid_{}.txt'.format(cid), 'w')
