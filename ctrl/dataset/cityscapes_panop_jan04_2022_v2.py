...
class CityscapesDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.set == 'train':
            ...
            #                    train_mode='val', foreground=foreground, semantic_weights=semantic_weights, instance=instance)
    ...
    def visualize(self, name, image, semantic, center, center_w, offset, offset_w, visdepth=False, depth=None, mode=None, train_mode=None,  foreground=None, semantic_weights=None, instance=None):
        ...
        if 'train_oracle' in train_mode or 'val' in train_mode:
            ...
            save_annotation(semantic, save_dir, fname_semantic, add_colormap=True,
                            colormap=self.create_label_colormap(16), image=im4Vis, blend_ratio=0.7, DEBUG=self.cfg.DEBUG)
