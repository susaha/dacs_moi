...
class SYNTHIADataSetDepth(data.Dataset):
    ...
    def visualize(self, name, image, semantic, center, center_w, offset, offset_w, visdepth=False, depth=None):
        save_dir = '/media/suman/DATADISK2/apps/experiments/CVPR2022/synthia_panoptic_gt_label_visualization_Jan_31/synthia_panop_jan04_2022_v2/crowd-th-{}'.format(self.crowd_th)
    ...
    def __getitem__(self, index):
        ...
        if self.cfg.DACS_RANDOM_CROP:
            ...
            image, label_panop, depth = self.dacs_random_crop(image, label_panop, use_depth=True, depth=depth)
