...
class CrossEntropy2D(nn.Module):
    def __init__(self):
        ...
        self.logger.info('ctrl/utils/loss_functions.py --> class CrossEntropy2D --> __init__()')
...
class BerHuLossDepth(nn.Module):
    def __init__(self):
        ...
        self.logger = logging.getLogger(__name__)
        self.logger.info('ctrl/utils/loss_functions.py --> class BerHuLossDepth --> __init__()')
...
class BCELossSS(nn.Module):
    def __init__(self):
        ...
        self.logger = logging.getLogger(__name__)
        self.logger.info('ctrl/utils/loss_functions.py --> class BCELossSS --> __init__()')
