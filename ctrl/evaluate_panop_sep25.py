...
def eval_panoptic(config, model, eval_folder, writer, i_iter, logger, device, data_loader, img_ids):
    ...
    try:
        ...
        with torch.no_grad():
            ...
            for i, batch in enumerate(data_loader):
                ...
                if i % config.TEST.DISPLAY_LOG_EVERY == 0:
                ...
                # Processed outputs
                if panoptic_pred is not None and i in img_ids:
                    tbc += 1
                    debug_out_dir = eval_folder['debug_test']
